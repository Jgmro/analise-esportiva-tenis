...
def main():
    ...
    # Modelo dos keypoints da quadra
    print("Loading court line detector...")
    ...
    print("Players filtered!")

    print("Setting up mini court...")
    mini_court = MiniCourt(video_frames[0])
    print("Mini court ready!")

    print("Detecting ball shots...")
    ball_shot_frames = ball_tracker.get_ball_shot_frames(ball_detections)
    print(f"Ball shots detected: {len(ball_shot_frames)}")
